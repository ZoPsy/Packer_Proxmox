...
# Variables d'installation de la VM
variable "bios_type" {
  type = string
}
...
# Variables pour l'accès API Proxmox
...
build {
  ...
  provisioner "shell" {
    inline = [
      ...
      "sudo apt-get update",
      "sudo apt-get install -y ca-certificates curl gnupg lsb-release gnupg2 software-properties-common",
